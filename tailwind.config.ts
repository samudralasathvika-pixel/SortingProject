  ...
  theme: {
    ...
    extend: {
      ...
      textColor: {
        ...
        "code-active": "hsl(var(--code-line-active))",
      },
      backgroundColor: {
        "code-bg": "hsl(var(--code-bg))",
        "bar-default": "hsl(var(--bar-default))",
        "bar-compare": "hsl(var(--bar-compare))",
        "bar-swap": "hsl(var(--bar-swap))",
        "bar-sorted": "hsl(var(--bar-sorted))",
        "bar-pivot": "hsl(var(--bar-pivot))",
        "bar-active": "hsl(var(--bar-active))",
      },
      keyframes: {
